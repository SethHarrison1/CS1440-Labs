...
public class TicketKiosk
{
    ...
    public void purchaseTickets(Scanner keyboard)
    {
        ...
        while (!name.equals("exit"))
        {
            ...
            System.out.println("Ener your Flight Number:");
            int fltNum = keyboard.nextInt();
            Flight flight = findFlight(fltNum);
            if (flight != null)
            {
            ...
            else
            {
                ...
                System.out.println("Press Emnter to Continue");
                keyboard.nextLine();
                keyboard.nextLine();
            }
            printSchedule();
    ...
    public Flight readOneFlight(Scanner inFile) throws IOException
    {
        ...
        return new Flight(fltNum, date, pilot, destination);
    }   
}
